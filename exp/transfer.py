...
if __name__=="__main__":
    fc_x_df=pd.DataFrame(fc_dict_x)
    fc_x_npy=fc_x_df.values
    fc_6_df=pd.DataFrame(fc_dict_6)
    fc_6_npy=fc_6_df.values
    np.save("fc_x.npy",fc_x_npy)
    np.save("fc_6.npy",fc_6_npy)